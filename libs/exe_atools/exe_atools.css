...
body.exe-atools-od .exe-content{font-family:opendyslexic, serif}
...
body.exe-atools-ah .exe-content{font-family:'Atkinson Hyperlegible', sans-serif}
...
body.exe-atools-mo .exe-content{font-family:'Montserrat', sans-serif}
...
#eXeAtoolsSet{display:none;font-size:12px;font-family:Arial, sans-serif;position:fixed;bottom:0;left:0;background:#000;border-top-right-radius:4px;z-index:999999;white-space:nowrap;height:35px}
...
#eXeAtools select{margin:0;padding:0;font-size:12px;font-family:Arial, sans-serif;background:#fff;color:#000;border:2px solid #fff; padding:2px 2px 1px 5px;margin:0 5px 0 10px;position:relative;top:6px;vertical-align:top}
...
#eXeAtools #eXeAtoolsUppercaseBtn{background:none;background-color:#111;position:relative;display:inline-flex;align-items:center;justify-content:center;vertical-align:top}
#eXeAtools #eXeAtoolsUppercaseBtn:after{content:"Aa";display:block;color:#fff;font:700 15px/1 Arial,sans-serif;line-height:1}
#eXeAtools #eXeAtoolsUppercaseBtn.eXeAtoolsActive:after{color:yellow;text-decoration:underline}
#eXeAtools #eXeAtoolsResetBtn.reset-disabled{opacity:.5;cursor:not-allowed}
#eXeAtools #eXeAtoolsSetDragHandler:hover{opacity:1}
body.exe-atools-uc .exe-content{text-transform:uppercase}
